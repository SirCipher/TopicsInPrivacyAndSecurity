...
public class Steganography_View extends JFrame
{
	...
	public Steganography_View(String name)
	{
		...
		encode = new JMenuItem("Add secret message to image"); encode.setMnemonic('E'); file.add(encode);
		encode.setEnabled(false);
		decode = new JMenuItem("Load stego-image"); decode.setMnemonic('D'); file.add(decode);
		file.addSeparator();
	...
	private class Text_Panel extends JPanel
	{
		...
		public Text_Panel()
		{
	    	...
	    	encodeButton = new JButton(">> Type secret message above and then press here <<");
	...
	private class Image_Panel extends JPanel
	{
		...
		public Image_Panel()
		{
	    	...
	    	decodeButton = new JButton(">> Press here to extract secret message <<");
	    	layoutConstraints.gridx 	= 0; layoutConstraints.gridy = 1; 
			layoutConstraints.gridwidth = 1; layoutConstraints.gridheight = 1; 
			layoutConstraints.fill 		= GridBagConstraints.BOTH; 
			layoutConstraints.insets 	= new Insets(0,-5,-5,-5); 
